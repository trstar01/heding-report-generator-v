...

{
  ...
  "salaryBands": [
    ...
    {"label": "스타트업 (후보자 실제 업종 기준)", "left": 8, "width": 24, "color": "rgba(255,255,255,.25)", "range": "X~X억 +RSU"},
    {"label": "중견·외국계 (후보자 실제 업종 기준)", "left": 12, "width": 32, "color": "rgba(255,255,255,.35)", "range": "X~X억"},
    {"label": "대기업 팀장급 (후보자 실제 업종 기준)", "left": 30, "width": 40, "color": "var(--gold2)", "range": "X~X억 ★목표"},
    {"label": "대기업 임원급 (후보자 실제 업종 기준)", "left": 50, "width": 50, "color": "rgba(255,255,255,.3)", "range": "X~X억+"}
  ],
